...
from preprocess import Loader, apply_noise
from model import scCMA
...
def train(args):
    ...
    model_checkpoint = 'scCMA_checkpoint.pth'
...
if __name__ == "__main__":
    for i in range(1):
        ...
        files = ["10X_PBMC", "worm_neuron", "CITE_CBMC", "human_kidney",
                 "Human1","Human2", "Human3", "Human4", "HumanLiver", "Mouse1", "Mouse2", "Zeisel",
                 "mouse_bladder"]
        ...
        for dataset in files:
            ...
            args["save_path"] = make_dir("run/result/" + str(i), dataset)
